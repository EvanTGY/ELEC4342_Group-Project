...
def main():
    ...
    # model.load_state_dict(torch.load(r'dynamic_quantized_resnet18.pth', map_location=torch.device('cpu')))
    state_dic = torch.load(r'Trained_Models_test/resnet18_dataset5_retrain.pth', map_location=torch.device('cpu'))
